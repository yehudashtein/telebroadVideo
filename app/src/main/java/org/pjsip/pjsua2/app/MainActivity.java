        ...
        adb.setPositiveButton("OK",
            new DialogInterface.OnClickListener()
            {
                public void onClick(DialogInterface dialog,int id)
                {
                    ...
                    String acc_id = "sip:" + username + "@" + Account.TELEBROAD_SERVER;
                    String registrar = "sip:" + Account.TELEBROAD_SERVER;
                    String proxy         = "sip:" + Account.TELEBROAD_SERVER;

                    String password  = etPass.getText().toString();

                    TextView tv = (TextView) findViewById(R.id.id);
                    tv.setText("id: " + acc_id);
                    tv = (TextView) findViewById(R.id.register);
                    tv.setText("register: " + registrar);
                    tv = (TextView) findViewById(R.id.proxy);
                    tv.setText("proxy: " + proxy);
                    tv = (TextView) findViewById(R.id.username);
                    tv.setText("username: " + username);
                    tv = (TextView) findViewById(R.id.pass);
                    tv.setText("pass: " + password);
                    ...
                    try {
                        ...
                        Log.d("yehuda", "onClick: account.modify() failed " + e.getMessage());
                    }
                }
            }
        );
